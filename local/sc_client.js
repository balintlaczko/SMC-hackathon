...
socket.on("sensors", (data) => {
    ...
    const orientationRadians = sensors.orientationRadians;
    ...
    const orientationRadiansMessage = new OSC.Message('/tosc/sensors/orientationRadians', orientationRadians.theta, orientationRadians.phi);
    ...
    const bundle = new OSC.Bundle(idMessage, orientationMessage, orientationRadiansMessage, accelerationMessage, accelerationIncludingGravityMessage, rotationRateMessage);
    bundle.pack();
    osc.send(bundle);
